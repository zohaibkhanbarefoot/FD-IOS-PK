...
- (id)init
{
    ...
    if (self)
    {
        ...
        self.locationManager.desiredAccuracy = distanceAccuracy;
        self.locationManager.distanceFilter = distanceFilterval;
   ...
   //     self.locationManager.desiredAccuracy = kCLLocationAccuracyBest;
     //   self.locationManager.distanceFilter = kCLDistanceFilterNone;
      //  self.locationManager.delegate = self;
       self.significantLocationManager = [[CLLocationManager alloc] init];
        self.significantLocationManager.desiredAccuracy = kCLLocationAccuracyBest;
        self.significantLocationManager.distanceFilter = 5;
        self.significantLocationManager.delegate = self;
    //    self.locationType = LocationManagerTypeStandart;
    }
    return self;
...
-(void)reset:(BOOL)ishigh{
 ...
 //   self.locationManager=nil;
   ...
   // if(appdelegate.Beacon)
    [self start];
    NSLog(@"my accuracy is being  changed");
    [changeLocAccuracyTimer invalidate];
    changeLocAccuracyTimer=nil;
    changeLocAccuracyTimer = [NSTimer scheduledTimerWithTimeInterval:15
                                     target:self
...
-(void)changeAccuracy{
  ...
  //  [self stop];
   ...
   // self.locationManager = [[CLLocationManager alloc] init];
    ...
    self.locationType = LocationManagerTypeStandart;
    self.allowsBackgroundLocationUpdates=YES;
    NSLog(@"my accuracy changed = %i",appdelegate.Beacon);
   if(appdelegate.Beacon)
        [self start];
